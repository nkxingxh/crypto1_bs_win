...
solve_bs32.exe:
	$(MINGW32) $(CFLAGS) solve_bs.c $(CRYPTO1_BS) $(CRAPTO1) ${CRAPTEV1} -static -m32 -o $@ -lpthread

solve_bs64.exe:
	$(MINGW32) $(CFLAGS) solve_bs.c $(CRYPTO1_BS) $(CRAPTO1) ${CRAPTEV1} -static -m64 -o $@ -lpthread

solve_piwi_bs32.exe:
	$(MINGW32) $(CFLAGS) solve_piwi_bs.c $(CRYPTO1_BS) $(CRAPTO1) ${CRAPTEV1} -static -m32 -o $@ -lpthread

solve_piwi_bs64.exe:
	$(MINGW64) $(CFLAGS) solve_piwi_bs.c $(CRYPTO1_BS) $(CRAPTO1) ${CRAPTEV1} -static -m64 -o $@ -lpthread

solve_piwi32.exe:
	$(MINGW32) $(CFLAGS) solve_piwi.c $(CRYPTO1_BS) $(CRAPTO1) ${CRAPTEV1} -static -m32 -o $@ -lpthread

solve_piwi64.exe:
	$(MINGW64) $(CFLAGS) solve_piwi.c $(CRYPTO1_BS) $(CRAPTO1) ${CRAPTEV1} -static -m64 -o $@ -lpthread
